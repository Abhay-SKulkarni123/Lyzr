...
type PreviewStatusProps = { status: Status };

export function PreviewStatus({ status }: PreviewStatusProps) {
  ...
  return (
    <div
      aria-live="polite"
      className="absolute left-1/2 top-3 z-20 flex -translate-x-1/2 items-center gap-2 rounded-full border border-emerald-400/25 bg-[#0c1018]/90 px-3 py-1.5 shadow-lg backdrop-blur"
    >
